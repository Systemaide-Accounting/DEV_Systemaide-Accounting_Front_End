...
export function PrintPurchasesJournal() {
    ...
    const downloadPDF = () => {
        ...
        html2canvas(input).then((canvas) => {
            ...
            pdf.save(`PurchasesJournal_${startDate}-${endDate}.pdf`);
        });
    };
    ...
    const downloadExcel = () => {
        ...
        worksheet['A1'] = { t: 's', v: 'Purchases Journal', s: {
        ...
        const data = reportData.map(item => ({
            ...
            'Supplier\'s Name': item.supplierName?.registeredName,
        ...
        worksheet['!cols'] = [
            ...
            { wch: 25 }, // Supplier's Name column width
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Purchases Journal");
        
        // Save file
        XLSX.writeFile(workbook, `PurchasesJournal_${startDate}-${endDate}.xlsx`);
    };
