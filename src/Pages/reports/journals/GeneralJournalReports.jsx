...
export function GeneralJournalReports() {
  ...
  const handlePreviewReport = () => {
    ...
    const url = `${baseUrl}#/reports/print-general-journal`;
              ...
              {reportData?.length > 0 ? (
                    ...
                    <Table.Body className="divide-y">
                      {reportData?.map((item) => (
                        <Table.Row key={item?.id} className="bg-white">
                          ...
                          <Table.Cell>{item?.jvNo}</Table.Cell>
                ...
                <div className="text-center p-8 border rounded-md bg-gray-50">
                  <p className="text-gray-500">
                    No general report found for the selected date range.
                  </p>
                </div>
              )}
            </div>
