...
import { deleteSalesAccountTransaction, getAllSalesAccountTransactions } from "../../services/systemaideService";
  ...
  return (
    <>
      <div className="bg-white p-4">
        <h1 className="text-2xl font-semibold mb-4">Sales on Account Transactions</h1>
