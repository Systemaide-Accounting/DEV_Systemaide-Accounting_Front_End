...
export function PrintSalesJournal() {
    ...
    const downloadPDF = () => {
        ...
        html2canvas(input).then((canvas) => {
            ...
            pdf.save(`SalesJournal_${startDate}-${endDate}.pdf`);
        });
    };
    ...
    const downloadExcel = () => {
        ...
        worksheet['A1'] = { t: 's', v: 'Sales Journal', s: {
        ...
        const data = reportData.map(item => ({
            ...
            'Customer\'s Name': item.customerName?.registeredName,
        ...
        worksheet['!cols'] = [
            ...
            { wch: 25 }, // Customer's Name column width
        ...
        // Save file
        XLSX.writeFile(workbook, `SalesJournal_${startDate}-${endDate}.xlsx`);
    };
              ...
              <tbody className="divide-y divide-gray-200">
                {reportData?.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="font-normal p-2 border-b border-gray-200">
                      {item?.customerName?.registeredName}
                    </td>
                    <td className="font-normal p-2 border-b border-gray-200">
                      {item?.particular}
                    </td>
